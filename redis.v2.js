...
const app = express();
const { exists, set, incrby, get, setnx } = require("./model.redis");
...
app.get("/order", async (req, res) => {
  ...
  if (!getKey) {
    // set = 0
    // Luu y: neu co dong thoi hai hay nhieu nguoi dong thoi mua 1 luc thi su dung netNX se khong duoc dat lai
    console.log("set nx");
